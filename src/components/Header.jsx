...
import "../App.css";
import Logo from "../assets/Kaocar-Ahamed.png";
    ...
    <div className="container flex items-center justify-between">
      ...
      <form className="flex items-center" onChange={handleSubmit}>
        <div className="group relative rounded-md bg-white">
          ...
          <input type="text" placeholder="Filter books..." className="search" id="lws-searchBook" onChange={(e) => setinput(e.target.value)}/>
        </div>
      </form>
    </div>
  </nav>
